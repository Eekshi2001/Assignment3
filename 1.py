...
employee1 = Employee("Eekshitha", "Gujjala Family", 550000, "HR")
employee2 = Employee("Vardhan", "Gujjala Family", 500000, "IT")

fulltime_employee = FulltimeEmployee("Candy", "Candy Family", 70000, "Finance", "Full-time")
